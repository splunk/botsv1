...
Alternatively, a much smaller version of the dataset that contains only attack data. In other words, "just the needles, no haystack." [botsv1-attack-only.tgz](https://s3.amazonaws.com/botsv1/botsv1-attack-only.tgz)(135MB conpressed)
